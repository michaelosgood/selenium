...
const admin_test = async function() {
    ...
    try {
        ...
        await driver.get(environment.aws_prod);
        console.log("Went to AWS Production");
       ...
       await driver.get("https://aws-web.prescribewellness.com/MessageManagement");
       ...
       await driver.get('https://aws-web.prescribewellness.com/CommunicationTemplates');
       ...
       await driver.get('https://aws-web.prescribewellness.com/CampaignManagement');
       ...
       await driver.get('https://aws-web.prescribewellness.com/CampaignManagement/CommPlanTemplates');
       ...
       await driver.get('https://aws-web.prescribewellness.com/BulkCampaignManagement');
       console.log("Went to Campaign Management");
       await driver.sleep(3000);
       console.log("Waited 3 seconds");
       await driver.getTitle().then(function (title) {
       ...
       // Mass Operations
       await driver.get('https://aws-web.prescribewellness.com/Admin/BatchOperation');
       ...
       await driver.get('https://aws-web.prescribewellness.com/CampaignManagement/CampaignTools');
       ...
       await driver.get('https:/aws-web.prescribewellness.com/CallHistory');
       ...
       await driver.get('https://aws-web.prescribewellness.com/Ncl/Global');
       ...
       await driver.get('https://aws-web.prescribewellness.com/Admin/AdminAccount/LoginAs');
       ...
       await driver.get('https://aws-web.prescribewellness.com/Admin/AdminAccount/UserManagement');
       ...
       await driver.get('https://aws-web.prescribewellness.com/Admin/AdminPartner/PartnerManagement');
       ...
       await driver.get('https://aws-web.prescribewellness.com/Admin/AdminDealer/DealerManagement');
       ...
       await driver.get('https://aws-web.prescribewellness.com/Account/Manage#information');
