...
const admin_test = async function() {
    ...
    try {
       ...
       await driver.get("https://localhost:44340/MessageManagement");
       ...
       await driver.get('https://localhost:44340/CommunicationTemplates');
       ...
       await driver.get('https://localhost:44340/CampaignManagement');
       ...
       await driver.get('https://localhost:44340/CampaignManagement/CommPlanTemplates');
       ...
       await driver.get('https://localhost:44340/BulkCampaignManagement');
       console.log("Went to Campaign Management");
       await driver.sleep(3000);
       console.log("Waited 3 seconds");
       await driver.getTitle().then(function (title) {
       ...
       // Mass Operations
       await driver.get('https://localhost:44340/Admin/BatchOperation');
       ...
       await driver.get('https://localhost:44340/CampaignManagement/CampaignTools');
       ...
       await driver.get('https://localhost:44340/CallHistory');
       ...
       await driver.get('https://localhost:44340/Ncl/Global');
       ...
       await driver.get('https://localhost:44340/Admin/AdminAccount/LoginAs');
       ...
       await driver.get('https://localhost:44340/Admin/AdminAccount/UserManagement');
       ...
       await driver.get('https://localhost:44340/Admin/AdminPartner/PartnerManagement');
       ...
       await driver.get('https://localhost:44340/Admin/AdminDealer/DealerManagement');
       ...
       await driver.get('https://localhost:44340/Account/Manage#information');
