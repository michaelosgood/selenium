...
const chain_partner = async function() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.get("https://web.prescribewellness.com/Patient/Details?patientId=01DDDB4C6ECD41D3A3DFCA37E613147A");
       ...
       // Click on the Overview tab
        ...
        // Vaccines tab
        await driver.get("https://web.prescribewellness.com/Patient/Vaccinations?patientId=01DDDB4C6ECD41D3A3DFCA37E613147A&timer=true");
        ...
        // eCare tab
        await driver.get(pt_profile.prod_ecare);
