...
const pt_list_test = async function() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.get(vaccinations.beta);
        ...
        // Calendar
        await driver.get(calendar.beta);
        ...
        // Social Calendar
        await driver.get(calendar.beta_social);
        ...
        /// Custom Calendar
        await driver.get(calendar.beta_custom);
        await driver.sleep(3000);
