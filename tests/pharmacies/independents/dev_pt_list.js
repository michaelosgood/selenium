...
const pt_list_test = async function() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.get(vaccinations.dev);
        ...
        // Social Calendar
        await driver.get(calendar.dev_social);
        ...
        /// Custom Calendar
        await driver.get(calendar.dev_custom);
        await driver.sleep(3000);
