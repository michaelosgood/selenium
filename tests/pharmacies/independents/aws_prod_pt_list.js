...
const pt_list_test = async function() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.get(eld_hrm.aws_prod);
        ...
        await driver.get(vaccinations.aws_prod);
        ...
        // Calendar
        await driver.get(calendar.aws_prod);
        ...
        // Social Calendar
        await driver.get(calendar.aws_prod_social);
        ...
        /// Custom Calendar
        await driver.get(calendar.aws_prod_custom);
        await driver.sleep(3000);
