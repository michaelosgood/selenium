...
const pt_profile_test = async function() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.get(pt_profile.beta);
        ...
        await driver.get(pt_profile.beta_medsync);
        ...
        // Vaccines tab
        await driver.get('https://beta-web.prescribewellness.com/Patient/Vaccinations?patientId=4C879922FBAB456B8D3BE60036742939&timer=true');
        ...
        // eCare tab
        await driver.get('https://beta-web.prescribewellness.com/Patient/eCarePlans?patientId=4C879922FBAB456B8D3BE60036742939&timer=true');
