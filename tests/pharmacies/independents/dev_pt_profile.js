...
const pt_profile_test = async function() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.get(pt_profile.dev);
        ...
        await driver.get(pt_profile.dev_medsync);
        ...
        // Vaccines tab
        await driver.get('https://dev-web.prescribewellness.com/Patient/Vaccinations?patientId=AB6002230683436188168042F8DF9D88&timer=true');
        ...
        // eCare tab
        await driver.get('https://dev-web.prescribewellness.com/Patient/eCarePlans?patientId=AB6002230683436188168042F8DF9D88&timer=true');
