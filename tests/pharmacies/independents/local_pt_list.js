...
const pt_list_test = async function() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.get(eld_hrm.local);
        ...
        await driver.get(vaccinations.local);
        ...
        // Calendar
        await driver.get(calendar.local);
        ...
        // Social Calendar
        await driver.get(calendar.local_social);
        ...
        /// Custom Calendar
        await driver.get(calendar.local_custom);
        await driver.sleep(3000);
