...
(async function SignIn() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.findElement(By.id('mbr-uid')).sendKeys(credentials.betaEastMariettaPartner_user);
        console.log("Entered Partner Admin username");
        await driver.findElement(By.id('mbr-pwd')).sendKeys(credentials.betaEastMariettaPartner_password, Key.RETURN);
