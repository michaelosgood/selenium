...
(async function pmp_2587() {
  let driver = await new Builder().forBrowser('chrome').build();
    try {
        ...
        await driver.findElement(By.className(pt_search.dev_input)).sendKeys('Bagwell');
        console.log("Searched for Bagwell");
        await driver.sleep(5000);
        console.log("Waited 5 seconds");
        await driver.findElement(By.className(pt_search.dev_input)).click();
        await driver.sleep(5000);
        console.log("Waited 5 seconds");
        await driver.findElement(By.className(pt_search.dev_button)).click();
        console.log("Clicked on 'Search' button");
        await driver.sleep(5000);
        console.log("Waited 5 seconds");
        await driver.findElement(By.className(pt_search.dev_result)).click();
        await driver.sleep(5000);
        console.log("Waited 5 seconds");
